...
// These imports are bundler-specific (Vite) and don't work in
// a plain browser environment.  The CSS/JS for Bootstrap and any local
// styles should be included via <link> / <script> tags in the HTML.
...
function initAuthUI() {
    console.debug('initAuthUI running');
    // --- DOM Elements ---
    ...
    toSignupBtn?.addEventListener('click', (e) => {
        console.debug('toSignup clicked');
        e.preventDefault();
        hideError();

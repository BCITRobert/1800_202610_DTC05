            ...
            <nav class="bg-gray-400 px-4 py-3">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <form id="authControls" class="flex items-center gap-2">
                        <input class="px-3 py-1.5 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-400" type="search" placeholder="Search" aria-label="Search" id="searchInput>
                        <button class="px-4 py-1.5 border-2 border-gray-500 text-gray-600 font-bold rounded hover:bg-gray-500 hover:text-white transition" type="submit">Filter</button>
